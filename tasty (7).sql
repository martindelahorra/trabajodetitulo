...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-08-2019 a las 08:33:12
...
(6, 'Tabla 500 piezas', 13, 'http://localhost:8000/image/gwa6vPJQh10q1bbJeJIDKkhgsmTQYF3LrTlZofH1.jpeg'),
(7, 'Tabla 100 piezas', 30000, 'http://localhost:8000/image/sckma9waQ2a4HFTKmPONBxnuTq5LYVzTJdIQ2PfP.jpeg');
...
--
ALTER TABLE `pizzas_ingredientes`
  MODIFY `cod_pi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `tabla_sushis`
  MODIFY `cod_tabla` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
